...
class Install extends CI_Controller
{
	...
	public function index()
	{
		...
		if ($this->db->table_exists('sessions'))
			show_error('NITW Judge is already installed.');
